  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="border-retro line-clamp-1 cursor-pointer bg-amber-400 px-4 py-1 font-statliches text-2xl active:scale-110 max-md:text-lg max-sm:max-w-[180px] max-sm:px-2">
          {projectTitle}
        </h2>
      </motion.nav>
    </>
